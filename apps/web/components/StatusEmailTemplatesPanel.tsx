 ...
 * automated Order/Repair status-change emails -- sent through the
 * business's own connected Gmail account (Integrations tab), not the
 * paid Resend path EmailSenderConfig backs. Rendered server-side by
 * StatusEmailService with simple {{placeholder}} substitution, no
 * template engine. */
